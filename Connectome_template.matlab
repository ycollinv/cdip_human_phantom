...
%% Set the template
files_in.network = '/gs/project/gsf-624-aa/database2/ccna/ccna_multisite_TR_20160201/atlas/template_cambridge_basc_multiscale_sym_scale007.mnc';

%% Preprocessing data localisation
files_in.fmri = niak_grab_fmri_preprocess('/gs/project/gsf-624-aa/database2/ccna/ccna_multisite_TR_20160201/ccna_multisite_TR_preprocess_20160201/',opt_g).fmri; 
...
opt_g.min_xco rr_anat = 0.5; % The minimum xcorr score for an fMRI dataset to be included. This metric is a tool for quality control which assess the quality of non-linear coregistration of the anatomical image in stereotaxic space. Manual inspection of the values during QC is necessary to properly set this threshold.
